...
po::options_description ParameterOptions::getGeneralOptions() {
  ...
  general.add_options()("readtype,r", po::value<std::string>()->default_value("SE"),
...
po::options_description ParameterOptions::getPreprocessOptions() {
  ...
  preprocess.add_options()("trimpolyg", po::bool_switch()->default_value(false),
...
po::options_description ParameterOptions::getDetectOptions() {
  ...
  detect.add_options()("nrgmax", po::value<double>()->default_value(0.0),
